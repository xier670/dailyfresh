...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = 'TTSX_xier@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'JYDWPMNJOXQEHHVE'
# 收件人看到的发件人
EMAIL_FROM = '天天生鲜<TTSX_xier@163.com>'
...
FDFS_URL='http://172.17.40.44:8888/'
